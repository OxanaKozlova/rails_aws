...
(function() {
  ...
  window.Preview = (function() {
    function Preview(form) {
      ...
      this.hideIfEmptyImage = bind(this.hideIfEmptyImage, this);
      this.input = form.find('input[type="file"]');
      this.image = form.find('img#img_prev');
      this.hideIfEmptyImage();
      this.changeImage();
    }

    Preview.prototype.hideIfEmptyImage = function() {
      if (this.image.attr('src') == null) {
        return $('.preview').hide();
      }
    };

    Preview.prototype.changeImage = function() {
  ...
  $(function() {
    if ($('.preview-container')[0]) {
      return new window.Preview($('.preview-container'));
    }
  });
